...
import com.dayouzc.e2eapp.ebusiness.checkin.vertical.di.component.DaggerStatisticsComponent;
import com.dayouzc.e2eapp.ebusiness.checkin.vertical.mvp.contract.StatisticsContract;
import com.dayouzc.e2eapp.ebusiness.checkin.vertical.mvp.presenter.StatisticsPresenter;
...
public class StatisticsActivity extends BaseActivity<StatisticsPresenter> implements StatisticsContract.View {
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.activity_statistics; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
