...
import com.dayouzc.e2e.core.activity.VerticalConnectionIserverActivity;
...
import com.dayouzc.e2eapp.ebusiness.checkin.vertical.di.component.DaggerHomeComponent;
import com.dayouzc.e2eapp.ebusiness.checkin.vertical.mvp.contract.HomeContract;
import com.dayouzc.e2eapp.ebusiness.checkin.vertical.mvp.presenter.HomePresenter;
import com.dayouzc.e2eapp.ebusiness.checkin.vertical.mvp.ui.adapter.CardRecyclerAdapter;
...
public class HomeActivity extends BaseActivity<HomePresenter> implements HomeContract.View {
    ...
    @BindView(R2.id.ic_home_where)
    TextView where;
    @BindView(R2.id.tv_home_info)
    TextView tv_home_info;
    @BindView(R2.id.tv_home_time)
    TextView time;
    @BindView(R2.id.tv_home_card)
    TextView tvHomeCard;
    @BindView(R2.id.tv_home_setting)
    TextView tvHomeSetting;

    @BindView(R2.id.rl_home_background)
    RelativeLayout rlHomeBackground;
    @BindView(R2.id.rl_home_show_card)
    RelativeLayout rlHomeShowCard;
    @BindView(R2.id.ll_home_show_set)
    LinearLayout llHomeShowSet;

    @BindView(R2.id.recycler_home_card)
    ...
    @OnClick({R2.id.rl_certificate, R2.id.rl_order, R2.id.rl_statistic, R2.id.btn_home_exit, R2.id.rl_home_card, R2.id.rl_home_set, R2.id.rl_home_background, R2.id.rl_home_wifi, R2.id.rl_home_update})
