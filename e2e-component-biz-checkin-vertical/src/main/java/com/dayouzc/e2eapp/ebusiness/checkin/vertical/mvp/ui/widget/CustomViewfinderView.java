package com.dayouzc.e2eapp.ebusiness.checkin.vertical.mvp.ui.widget;
...
public class CustomViewfinderView extends ViewfinderView {
     ...
     * 边角线颜色
     */
    public int mLineColor = getResources().getColor(R.color.color_0AABF6);
     ...
     * 线性梯度各个位置对应的颜色值
     */
    public int[] mScanLineColor = new int[]{0x00FFFFFF,mLineColor, 0x00FFFFFF};
